  ...
  return (
    <div className="flex-1 min-w-[140px]">
      ...
      <div className="flex items-baseline gap-1 mb-3">
        <span className="text-2xl font-bold">{data.avg.toFixed(1)}</span>
...
export const ProfileRatings = ({ userId, compact = false }: ProfileRatingsProps) => {
  ...
  if (compact) {
    // Compact view for ChefProfile - just show averages
    return (
      <div className="flex items-center gap-4 text-sm">
        {chefData.total > 0 && (
          <div className="flex items-center gap-1.5">
            <SpoonIcon className="w-4 h-4 text-amber-500" />
            <span className="font-bold">{chefData.avg.toFixed(1)}</span>
        ...
        {guestData.total > 0 && (
          <div className="flex items-center gap-1.5">
            ...
            <span className="font-bold">{guestData.avg.toFixed(1)}</span>
