      ...
      <main className="max-w-2xl mx-auto px-4 py-8 pb-24">
        ...
        <div className="space-y-6 text-foreground">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Die Köche sind allein verantwortlich für die Qualität, Hygiene und Deklaration 
              der Inhaltsstoffe (Allergene) ihrer Speisen. Neighbors Kitchen übernimmt keine 
              Haftung für gesundheitliche Schäden, die aus dem Konsum der vermittelten Speisen 
              entstehen.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Buchungen sind verbindlich. Stornierungen sind nur bis zu dem vom Koch 
              festgelegten Zeitpunkt möglich. Bei Nichterscheinen (No-Show) besteht kein 
              Anspruch auf Rückerstattung der Servicegebühr.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              ausser dies ist für die Abwicklung der Buchung notwendig (z.B. Weitergabe der 
              Adresse an den Gast nach Buchung). Wir nutzen Stripe für Zahlungen; es gelten 
