...
export const DEMO_MEALS = [
  ...
  {
    id: 'demo-3',
    title: 'Schweizer Käsefondue',
    description: 'Traditionelles Käsefondue mit Brot und Kartoffeln. Perfekt für kalte Abende!',
    chef: {
      first_name: 'Hans',
      last_name: 'M.',
      karma: 310,
      id_verified: false,
      phone_verified: true,
      nickname: 'Fondue-Hans',
      display_real_name: false,
    },
    image_url: 'https://images.unsplash.com/photo-1530610476181-d83430b64dcd?w=800&q=80',
    chef_id: 'demo-chef-3',
    fuzzy_lat: 47.5580,
    fuzzy_lng: 7.5920,
    neighborhood: 'Kleinbasel',
    tags: ['Schweizer Küche', 'Vegetarisch', 'Demo / Beispiel'],
    allergens: ['Milch/Laktose', 'Gluten (Getreide)'],
    ...
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    handover_mode: 'dine_in',
    arrival_time: '19:30',
    max_seats: 4,
    booked_seats: 1,
    unit_type: 'portions',
    exchange_mode: 'free',
    estimated_restaurant_value: 30,
    ingredients: ['Gruyère', 'Emmentaler', 'Weisswein', 'Knoblauch', 'Brot'],
    is_stock_photo: false,
    women_only: false,
  },
];
